...
en: {
    translation: {
        WELCOME_MESSAGE: 'Hello Eduardo! Thank you for using the degree converter',
        GET_MESSAGE_INIT: '- The result is: ',
        HELLO_MESSAGE: 'Hello world Eduardo',
...
es: {
    translation: {
        WELCOME_MESSAGE: '¡Hola Eduardo! Gracias por usar convertidor de grados',
